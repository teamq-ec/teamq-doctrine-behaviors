...
/** @var \TeamQ\DoctrineBehaviors\Contract\Entity\TranslatableInterface $category */
...
This library provides an interface `TeamQ\DoctrineBehaviors\Contract\Provider\LocaleProviderInterface` that [by default returns the current locale using Symfony `RequestStack` or `TranslatorInterface`](https://github.com/KnpLabs/DoctrineBehaviors/blob/master/src/Provider/LocaleProvider.php).
