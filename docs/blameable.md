...
If you want to change it, just implement `TeamQ\DoctrineBehaviors\Contract\Provider\UserProviderInterface` yourself and override native service.
...
/** @var TeamQ\DoctrineBehaviors\Contract\Entity\BlameableInterface $category */
